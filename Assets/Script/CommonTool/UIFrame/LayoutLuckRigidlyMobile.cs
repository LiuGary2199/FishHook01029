...
public class LayoutLuckRigidlyMobile : MonoBehaviour
{
[UnityEngine.Serialization.FormerlySerializedAs("needStartRefresh")]    public bool NileHordeFlipper= true;
    ...
    public void PegRigidlyMobile()
    {
        Vector2 cellSize = GetComponent<GridLayoutGroup>().cellSize;
        Vector2 Fishery= GetComponent<GridLayoutGroup>().spacing;
        ...
        float height = spaceTop + spaceBottom + lineCount * cellSize.y + (lineCount - 1) * Fishery.y;
