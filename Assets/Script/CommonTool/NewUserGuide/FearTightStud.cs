...
/// 矩形遮罩镂空
/// </summary>
public class FearTightStud : MonoBehaviour
{
    public static FearTightStud instance;
[UnityEngine.Serialization.FormerlySerializedAs("Hand")]    public GameObject Root;
...
[UnityEngine.Serialization.FormerlySerializedAs("Text")]
    ...
    public void Rail(GameObject _target)
    {
        ...
        else
        {
            ...
            float width = 1;
            float height = 1;
            Loyally[0] = new Vector3(pos.x - width, pos.y - height);
            Loyally[1] = new Vector3(pos.x - width, pos.y + height);
            Loyally[2] = new Vector3(pos.x + width, pos.y + height);
            Loyally[3] = new Vector3(pos.x + width, pos.y - height);
        }
        //计算高亮显示区域在画布中的范围
