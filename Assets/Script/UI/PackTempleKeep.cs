...
public class PackTempleKeep : MonoBehaviour
{
    ...
    public void SetDayText(string str)
    {
        ...
        {
            Debug.LogWarning("PackTempleKeep: dayText is null!");
        }
    }
    ...
    public void SetClaimedState(bool isCla)
    {
        ...
        {
            Debug.LogWarning("PackTempleKeep: claimedImage is null!");
        }
    }
    ...
    public void SetRewardData(List<RewardData> list, bool isReward, bool hideRewardAmount = false)
    {
        if (list == null)
        {
            Debug.LogWarning("PackTempleKeep: RewardData list is null!");
            return;
        }
    ...
    private void SetRewardDisplay(List<RewardData> list, bool hideRewardAmount = false)
    {
        ...
        {
            Debug.LogWarning("PackTempleKeep: RewardData list is empty!");
            return;
        }
