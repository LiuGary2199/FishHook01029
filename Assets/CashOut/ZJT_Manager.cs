...
//真假提 切换调用各种方法和获取数据
public class ZJT_Manager : MonoSnowstorm<ZJT_Manager>
{
    /// <summary> 提现模块是否准备好 </summary>
    public bool CashOutReady()
    {
#if ZT
        return CashOutManager.LawLaurasia().Ready;
#endif
    ...
    {
#if ZT
        CashOutManager.LawLaurasia().Login();
#endif
    ...
    {
#if ZT
        CashOutManager.LawLaurasia().StartTime = System.DateTimeOffset.UtcNow.ToUnixTimeMilliseconds();
#endif
    ...
    {
#if ZT
        CashOutManager.LawLaurasia().ReportEvent_LoadingTime();
#endif
    ...
    {
#if ZT
        return CashOutManager.LawLaurasia().Data.UserID;
#endif
    ...
    {
#if ZT
        return CashOutManager.LawLaurasia().EcpmRequestID();
#endif
    ...
    {
#if ZT
        CashOutManager.LawLaurasia().ReportAdjustID();
#endif
    ...
    {
#if ZT
        CashOutManager.LawLaurasia().AddTaskValue(Name, Value);
#endif
