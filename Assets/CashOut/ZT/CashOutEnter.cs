...
public class CashOutEnter : MonoBehaviour
{
    ...
    void Start()
    {
        CashOutManager.LawLaurasia()._CashOutEnter = this;
        OpenPanelBtn.onClick.AddListener(() => { UIStrange.LawLaurasia().BeatUIHouse(nameof(CashOutPanel)); });
        UpdateMoney();
    }
    ...
    public void UpdateMoney()
    {
        ...
        MoneyTextAnim = DOTween.To(() => MoneyStart, x => MoneyText.text = x.ToString("F2"), CashOutManager.LawLaurasia().Money, 1f);
